...
exports.metaDataRules = {
    ...
    url: {
        ...
        processor: function (url, context) { return utils_1.makeUrlAbsolute(context.url, url); }
    },
    provider: {
        rules: [
        ...
        defaultValue: function (context) { return utils_1.getProvider(utils_1.parseUrl(context.url)); }
    },
    keywords: {
        rules: [
    ...
    image: {
        ...
        processor: function (imageUrl, context) { return context.options.forceImageHttps === true ? utils_1.makeUrlSecure(utils_1.makeUrlAbsolute(context.url, imageUrl)) : utils_1.makeUrlAbsolute(context.url, imageUrl); }
    },
    icon: {
        rules: [
        ...
        defaultValue: function () { return 'favicon.ico'; },
        processor: function (iconUrl, context) { return context.options.forceImageHttps === true ? utils_1.makeUrlSecure(utils_1.makeUrlAbsolute(context.url, iconUrl)) : utils_1.makeUrlAbsolute(context.url, iconUrl); }
    },
    video: {
        rules: [
